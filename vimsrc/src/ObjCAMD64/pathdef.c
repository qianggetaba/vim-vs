...
char_u *all_lflags = (char_u *)"link  /nologo /subsystem:console /opt:ref /LTCG:STATUS oldnames.lib kernel32.lib advapi32.lib shell32.lib gdi32.lib  comdlg32.lib ole32.lib uuid.lib /machine:AMD64   libcmt.lib  user32.lib          WSock32.lib  /PDB:vim.pdb -debug"; 
